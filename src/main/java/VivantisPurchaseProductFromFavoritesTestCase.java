...
public class VivantisPurchaseProductFromFavoritesTestCase {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("delivery-firstname")).sendKeys("Claudiu");
        Thread.sleep(WebDriverConstants.MILLIS);
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("delivery-area")).sendKeys("Ba");
        Thread.sleep(WebDriverConstants.MILLIS);
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("delivery-city")).sendKeys("Bac");
        Thread.sleep(WebDriverConstants.MILLIS);
