...
public class DouglasCreateAccountTestCase {
    ...
    public void testUntitledTestCase() throws Exception {
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("personalFirstName")).sendKeys("<personal_first_name>");
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("personalLastName")).click();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("personalLastName")).clear();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("personalLastName")).sendKeys("<personal_last_name>");
        Thread.sleep(WebDriverConstants.MILLIS);
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("personalPassword")).sendKeys("<personal_password>");
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressStreet")).click();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressStreet")).clear();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressStreet")).sendKeys("<billing_address_address_street>");
        Thread.sleep(WebDriverConstants.MILLIS);
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressZipcode")).sendKeys("<billing_address_address_zipcode>");
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressCity")).click();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressCity")).clear();
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressCity")).sendKeys("<billing_address_address_city>");
        Thread.sleep(WebDriverConstants.MILLIS);
        ...
        Thread.sleep(WebDriverConstants.MILLIS);
        driver.findElement(By.id("billingAddressAddressPhoneNumber")).sendKeys("<billing_address_address_phone_number>");
        Thread.sleep(WebDriverConstants.MILLIS);
